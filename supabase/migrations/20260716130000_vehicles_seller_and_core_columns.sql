-- Core vehicle columns required by marketplace flows (missing from legacy base table).
...
-- Re-apply close function now that seller_id exists
...
BEGIN
  ...
  LOOP
    ...
    IF winning_user_id IS NOT NULL
       AND winning_amount IS NOT NULL
       AND vehicle_record.seller_id IS NOT NULL THEN
